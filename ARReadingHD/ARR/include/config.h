...
#define ARR_EACH_SEGMENT_EDGES_MAX 100
#define ARR_EACH_REGION_EDGES_MAX 100
#define ARR_EACH_REGION_SEGMENT_MAX 100
#define ARR_MERGED_SEGMENTS_MAX 1000   // 总的 merged_segments
#define ARR_LINE_WITH_CORNERS_MAX 100
#define ARR_EACH_MARKER_SEGMENT_MAX 5   //4? ARR_MARKER_CHAIN_MAX
#define ARR_MARKERS_MAX 100
